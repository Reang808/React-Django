...
function Service() {
  ...
  const services = [
    ...
    {
      title: "DX支援",
      desc: "以下のステップで伴走支援を行います。<br><br>[1] 現在の作業プロセスやボトルネックを分析し、改善の優先順位を決定します。<br><br>[2] 現場に合った効率的なワークフローへと再構築します。<br><br>[3] デジタルツール導入・自動化支援<br><br>[4] 蓄積されたデータを経営や業務に活かすための基盤づくりと分析をサポートします。<br><br>[5] 組織内の連携改善、全社的な効率化を図ります。",
      icon: "⚙️",
    },
    {
      title: "システム構築",
